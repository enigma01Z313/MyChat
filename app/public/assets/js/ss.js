  ...
  createAndSaveAKeyPair()
    .then(function () {
      ...
      document
        ...
        .addEventListener("click", encryptTheFile);
      document
        .getElementById("decrypt")
        .addEventListener("click", decryptTheFile);
    })
    .catch(function (err) {
  ...
  function encryptTheFile() {
    ...
    function processTheFile() {
      ...
      encrypt(plaintext, keyPair.publicKey)
        ...
        .catch(function (err) {
          alert(
            "Something went wrong encrypting: " + err.message + "\n" + err.stack
          );
        });
      ...
      function encrypt(plaintext, publicKey) {
        ...
        return window.crypto.subtle
          .generateKey({ name: "AES-CBC", length: 128 }, true, [
            "encrypt",
            "decrypt",
          ])
        ...
        function encryptPlaintext(sessionKey) {
          ...
          return window.crypto.subtle
            .encrypt({ name: "AES-CBC", iv: iv }, sessionKey, plaintext)
  ...
  function decryptTheFile() {
    ...
    function processTheFile() {
      ...
      decrypt(ciphertext, iv, encryptedKey, keyPair.privateKey)
        ...
        .catch(function (err) {
          alert(
            "Something went wrong decrypting: " + err.message + "\n" + err.stack
          );
        });
      ...
      function decrypt(ciphertext, iv, encryptedSessionKey, privateKey) {
        ...
        function decryptCiphertext(sessionKey) {
          ...
          return window.crypto.subtle
            .decrypt({ name: "AES-CBC", iv: iv }, sessionKey, ciphertext)
